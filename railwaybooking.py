...
u1 = user(5472, 'kiran', 'warangal', '7013290865',"kiran")
u2 = user(2322, 'alex parrish', 'new york', '7873752967')
u3=user(1234,"teja reddy","vangapahad","9393931931","teja reddy")
...
def load():
    ...
    with open("trains_data.pkl", "rb") as f:
...
def s():
    with open("trains_data.pkl", "wb") as f:
